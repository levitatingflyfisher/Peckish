...
void main() {
  test(
    ...
    // In-process the VM's timezone is fixed at startup (a US-rule host zone's
    // 02:00-Sunday transition never sits between two midnights of the same
    // Mon..Sun week), so the discriminating case runs as a child `dart`
    // process pinned to a zone whose transition falls at midnight mid-week:
    // America/Santiago, where Saturday 2026-04-04 has 25 hours.
