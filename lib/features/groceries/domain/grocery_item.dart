...
const _produce = [
  'apple', 'banana', 'orange', 'lemon', 'lime', 'berr', 'grape', 'melon',
  'peach', 'pear', 'plum', 'mango', 'avocado', 'tomato', 'potato', 'onion',
  'garlic', 'carrot', 'celery', 'pepper', 'lettuce', 'spinach', 'kale',
  'broccoli', 'cauliflower', 'cabbage', 'cucumber', 'zucchini', 'squash',
  'mushroom', 'corn', 'green bean', 'pea', 'herb', 'cilantro', 'parsley',
  'basil', 'ginger', 'salad',
];
const _meat = [
  'beef', 'chicken', 'turkey', 'pork', 'ham', 'bacon', 'sausage', 'steak',
  'lamb', 'fish', 'salmon', 'tuna', 'shrimp', 'meat',
];
const _dairy = [
  'milk', 'cheese', 'cheddar', 'mozzarella', 'parmesan', 'yogurt', 'butter',
  'cream', 'egg', 'sour cream',
];
const _bakery = [
  'bread', 'tortilla', 'bun', 'roll', 'bagel', 'muffin', 'croissant', 'pita',
  'naan',
];
const _pantry = [
  'flour', 'sugar', 'salt', 'rice', 'pasta', 'noodle', 'bean', 'lentil',
  'oil', 'vinegar', 'sauce', 'salsa', 'broth', 'stock', 'canned', 'cereal',
  'oat', 'honey', 'syrup', 'spice', 'cumin', 'paprika', 'cinnamon', 'vanilla',
  'chocolate', 'nut', 'peanut', 'almond', 'chip', 'cracker', 'jam', 'jelly',
];
